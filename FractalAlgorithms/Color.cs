namespace FractalAlgorithms
{
    public class Color
    {
        //public static int[,] colors = { { 0, 0, 255 }, { 0, 128, 255 }, { 0, 255, 255 }, { 0, 255, 0 }, { 255, 0, 0 }, { 128, 0, 128 }, { 255, 128, 255 }, { 0, 0, 0 } };
        public static int[,] colors = { { 0, 0, 255 }, { 0, 128, 255 }, { 0, 255, 255 }, { 0, 255, 128 }, { 0, 255, 0 }, { 128, 255, 0 }, { 255, 255, 0 }, { 255, 128, 0 }, { 255, 0, 0 } };
